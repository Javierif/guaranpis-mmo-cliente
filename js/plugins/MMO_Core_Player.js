...
(function () {
	...
	DataManager.setupNewGame = function () {
		...
		if (!MMO_Core_Player.hasInitialized) {
			Scene_Map.prototype.hideMenuButton.call(this);
			...
			MMO_Core_Player.callMenu = Game_System.prototype.isMenuEnabled;
			Game_System.prototype.isMenuEnabled = function() {
				return false;
			}

			MMO_Core_Player.callMenu = Scene_Map.prototype.callMenu;
			Scene_Map.prototype.callMenu = function () {
				console.log('Abrir menú');
			};

			MMO_Core_Player.updateCallMenu = Scene_Map.prototype.updateCallMenu;
			Scene_Map.prototype.updateCallMenu = function () {};

			MMO_Core_Player.createMenuButton = Scene_Map.prototype.createMenuButton;
			Scene_Map.prototype.createMenuButton = function () {
				console.log('quito botón menu');
			};
	...
	Game_Actor.prototype.setup = function (actorId) {
		...
		if (MMO_Core_Player.Player['stats'] !== undefined && MMO_Core_Player.Player['stats'] !== '') hasLoaded = true;
	...
	MMO_Core.socket.on('refresh_player_data', function (payload) {
		...
		MMO_Core_Player.Player = MMO_Core_Player.Player[0];
